...
export ZSH="/home/edddjunior/.oh-my-zsh"
...
# It returns a dir and calls the algorithm that deletes everything from Trash (also info files in /info)
alias det="cd ..; bash del_all.sh"
